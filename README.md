...
the top right and instead are a `c` this because you are running the old
version v0.1 of the package. Please install the latest version v0.2 to
resolve this.

# Overview

Welcome to the NHS-R community’s package for building a specific type of
statistical process control (SPC) chart, the XmR chart. The package
supports the NHS’s [‘Making Data
Count’](https://www.england.nhs.uk/publication/making-data-count/)
...
Conduct](https://github.com/nhs-r-community/NHSRplotthedots/blob/main/CODE_OF_CONDUCT.md).
