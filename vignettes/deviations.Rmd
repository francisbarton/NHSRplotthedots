...
The overall intent of this package is to mimic as completely as possible the output available from the [NHS Making Data Count][mdc] Excel tools.
...
spc_data |>
  ...
  labs(
    caption = paste(
      "UPL = ",
      round(spc_data$upl[1], 2),
      ", Mean = ",
      round(spc_data$mean_col[1], 2),
      ", LPL = ",
      round(spc_data$lpl[1], 2)
    )
  )
```
